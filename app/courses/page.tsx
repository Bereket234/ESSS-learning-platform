  ...
  return (
    <div>
      ...
      <div className='flex justify-center items-center mb-10'>
        <div className="min-w-[360px] px-3 sm:min-w-[480px] md:min-w-[640px] lg:min-w-[1020px] xl:min-w-[1390px] pt-6 pb-4 border-2 rounded-[50px] shadow-lg">
          <div className="flex px-5 items-center content-center flex-col sm:flex-col md:flex-col lg:flex-row">
            ...
            <div className="flex flex-col pl-12 flex-grow">
