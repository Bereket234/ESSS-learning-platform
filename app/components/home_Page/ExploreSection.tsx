...
const ExploreSection = () => {
  return (
    <section className="flex flex-col lg:flex-row min-h-[400px] lg:min-h-[600px] h-[80vh]">
      ...
      <div className="bg-slate-800 md:h-2/3 min-h-[200px] lg:h-full lg:w-2/3 gap-10 ">
        <div
